...
from backend.prompts.people_prompt import PEOPLE_PROMPT
...
class PeopleAgent:
    ...
    def analyze(
        ...
        """
        Identify key people at the company.

        Args:
            company_name: Company name
            website_url: Official website (to find /team or /about page)
            linkedin_url: LinkedIn company page URL

        Returns:
            Dict with executives, buying committee, decision-making structure, etc.
        """
